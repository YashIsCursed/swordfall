# Boss L2.gd - Boss with animation support
extends Mob
...
func _ready() -> void:
	...
	if anim_player:
		print("BossL2: Found AnimationPlayer at: ", anim_player.get_path())
		# Print all available animation names so we know exactly what to use
		var anim_list = anim_player.get_animation_list()
		print("BossL2: Available animations: ", anim_list)
	else:
		print("BossL2: WARNING - No AnimationPlayer found!")
